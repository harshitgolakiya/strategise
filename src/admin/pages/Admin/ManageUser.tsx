...
type Status = 'PAID' | 'APPROVED' | 'FAILED' | 'CANCEL' | 'SUCCESS' | 'PENDING' | 'COMPLETE';
...
const randomStatus = (): Status => {
    const statuses: Status[] = ['PAID', 'APPROVED', 'FAILED', 'CANCEL', 'SUCCESS', 'PENDING', 'COMPLETE'];
                        ...
                        columns={[
                            ...
                            { accessor: 'phone', title: 'Phone No.', sortable: true },
                            {
                                ...
                                render: () => {
                                    ...
                                    return <span className={`badge badge-outline-${statusColorMap[status]}`}>{status}</span>;
                                },
                            },
                            {
                                accessor: 'action',
