  ...
  return (
      <div>
          ...
          <div className="grid grid-cols-2 gap-5">
              <div className="mb-5 bg-[#00AB557D] p-5 rounded-3xl">
                  <h1 className="text-lg font-semibold mb-5">Strengths</h1>
                  <div className="space-y-2 font-semibold">
                      <div className="border border-[#d3d3d3] bg-white rounded dark:border-[#1b2e4b]">
                      ...
                      <div className="border border-[#d3d3d3] bg-white dark:border-[#1b2e4b] rounded">
                      ...
                      <div className="border border-[#d3d3d3] bg-white dark:border-[#1b2e4b] rounded">
                          <button type="button" className={`p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b] ${active === '3' ? '!text-primary' : ''}`} onClick={() => togglePara('3')}>
              ...
              <div className="mb-5 bg-[#EA616180] p-5 rounded-3xl">
                  <h1 className="text-lg font-semibold mb-5">Weaknesses</h1>
                  <div className="space-y-2 font-semibold">
                      <div className="border border-[#d3d3d3] bg-white rounded dark:border-[#1b2e4b]">
                          <button type="button" className={`p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b] ${active === '1' ? '!text-primary' : ''}`} onClick={() => togglePara('1')}>
                              Customer-Centric Approach
              ...
              <div className="mb-5 bg-[#17AB0680] p-5 rounded-3xl">
                  <h1 className="text-lg font-semibold mb-5">Opportunities</h1>
                  <div className="space-y-2 font-semibold">
                      <div className="border border-[#d3d3d3] bg-white rounded dark:border-[#1b2e4b]">
                          <button type="button" className={`p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b] ${active === '1' ? '!text-primary' : ''}`} onClick={() => togglePara('1')}>
                              Customer-Centric Approach
              ...
              <div className="mb-5 bg-[#E7515AB2] p-5 rounded-3xl">
                  <h1 className="text-lg font-semibold mb-5">Threats</h1>
                  <div className="space-y-2 font-semibold">
                      <div className="border border-[#d3d3d3] bg-white rounded dark:border-[#1b2e4b]">
                          <button type="button" className={`p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b] ${active === '1' ? '!text-primary' : ''}`} onClick={() => togglePara('1')}>
                              Customer-Centric Approach
