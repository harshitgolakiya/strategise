...
interface DisruptiveTechnologiesBoxProps {
    heading: string;
    options: string[];
}

const DisruptiveTechnologiesBox: React.FC<DisruptiveTechnologiesBoxProps> = (props) => {
    return (
...
const DisruptiveTechnologies: React.FC = () => {
    ...
    return (
        <>
            <div className="mb-5">
                <h1 className="font-bold text-lg mb-5">Disruptive Technologies</h1>
                <p className="text-gray-500">What technologies have the potential to disrupt our industry?</p>
            </div>
            <div className="sm:grid grid-cols-3 gap-5">
                <DisruptiveTechnologiesBox heading={heading} options={options} />
                <DisruptiveTechnologiesBox heading={heading} options={options} />
                <DisruptiveTechnologiesBox heading={heading} options={options} />
            </div>
        </>
...
export default DisruptiveTechnologies;
